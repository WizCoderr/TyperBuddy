...
<template>
    <CommonLayout>
        ...
        <p>
            ...
            of the TyperBuddy typing platform services ("Services"). By
        ...
        <ol>
            ...
            <li>
                Collect or harvest any information from other users without
                their consent.
            </li>
        </ol>
        <p>
            We reserve the right to suspend or terminate your access to the
            Services at any time for any reason, including if we believe that
            you have violated these Terms.
        </p>

        <h3>User Content</h3>
        <p>
            You retain ownership of any content that you submit or upload to the
            Services ("User Content").
        </p>
        <p>
            By submitting User Content, you grant us a worldwide, non-exclusive,
            royalty-free, transferable license to use, reproduce, modify, adapt,
            publish, translate, distribute, and display such User Content in
            connection with the operation and promotion of the Services.
        </p>
        <p>You represent and warrant that:</p>
        <ul>
            <li>
                You have the necessary rights to grant the license described in
                Section 3.2.
            </li>
            <li>
                Your User Content does not violate any applicable laws or
                regulations or infringe upon the rights of any third party.
            </li>
        </ul>
        ...
        <p>
            ...
            limited to trademarks, logos, and copyrights, are owned by or
            licensed to us.
        </p>
        <p>
            You may not use our trademarks, logos, or copyrighted material
        ...
        <p>
            ...
            the Services or any breach of these Terms.
        </p>
        ...
        <p>
            ...
            use of the Services after the posting of the revised Terms
