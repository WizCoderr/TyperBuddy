...
const ranks = ["_" ,"1st", "2nd", "3rd", "4th", "5th"]
...
function getProgress(pos: number){
    return Math.round(pos / prop.totalChars * 100) + "%"
}
        ...
        <table>
            ...
            <tbody>
                <tr v-for="player, index in players" :key="index">
                    ...
                    <td>
                        <div class="track">
                            <svg :style="{left: getProgress(player.score.cursorPos)}" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div class="status">
                                <span>Position: <b>{{ getRank(player.score.rank) }}</b></span>
